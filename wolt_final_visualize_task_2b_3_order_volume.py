...
# ==============================================================================
#
# Task 2 - Part B - Metric 3: order value
#
#   - Plot top 5 countries by order volume
#
...
sql_file = r'task2-b_order_volume_final.sql'
...
with open(sql_file) as file:
    ...
    yaxis_max_value = df_from_query['order_volume'].iloc[0]
    ...
    fig.add_trace(
        go.Bar(
            ...
            y=df_from_query['order_volume'],
            name="Order volume",
            text=df_from_query['order_volume'],
    ...
    fig.update_layout(
        title={
            'text': '<b>Top 5 countries by order volume</b>',
            'y': 0.95,
            'x': 0.5,
            'xanchor': 'center',
            'yanchor': 'top'},
