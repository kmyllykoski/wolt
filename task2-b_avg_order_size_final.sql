-- Wolt 
-- Assigment Task 2 - Top 5 countries by average order size
-- Average order size = number of items ordered in country / number of orders in country
--
...
GROUP BY c.country 
ORDER BY SUM(c.count) / COUNT(DISTINCT(c.purchase_id)) DESC
LIMIT 5
