# -*- coding: utf-8 -*-
__author__ = 'Kennet Myllykoski'
#
# Conda environment: python 3.8
#
# ==============================================================================
#
# Task 2 - Part B - Metric 2: averge order value
#
#   - Plot top 5 countries by average order value
#   
...
sql_file = r'task2-b_avg_order_value_final.sql'
...
with open(sql_file) as file:
    ...
    yaxis_max_value = df_from_query['avg_order_value'].iloc[0]
    ...
    fig.add_trace(
        go.Bar(
            ...
            y=df_from_query['avg_order_value'],
            name="Average order value",
            text=df_from_query['avg_order_value'],
    ...
    fig.update_layout(
        title={
            'text': '<b>Top 5 countries by average order value</b>',
            'y': 0.95,
            'x': 0.5,
            'xanchor': 'center',
            'yanchor': 'top'},
